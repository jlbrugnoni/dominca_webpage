const capabilities = [
  {
    title: 'Calidad',
    body: 'Define aqui tus controles: granulometria, blancura, humedad, resistencia, trazabilidad o ensayos por lote.',
  },
  {
    title: 'Logistica',
  ...
  {
    title: 'Desarrollo',
    body: 'Reserva espacio para mezclas especiales, productos privados, pruebas con clientes y soporte tecnico.',
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[0.8fr_1.2fr] gap-10">
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl font-bold leading-tight">
              Una seccion para demostrar por que comprarles a ustedes.
            </h2>
          </div>
